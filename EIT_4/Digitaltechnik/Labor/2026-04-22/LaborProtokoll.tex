...
\begin{figure}[H]
  ...
  \fbox{\rule{0pt}{5.5cm}\rule{12cm}{0pt}}
  \caption{Output $y$ (pin~3) -- astable multivibrator, NE555.}
...
$R_S = \SI{1}{\kilo\ohm}$ limits the maximum protection diode current to a safe value:
\[
...
investigation of the bypass capacitor value on switching stability.}
